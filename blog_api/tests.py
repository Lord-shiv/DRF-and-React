...
class PostTests(APITestCase):
    ...
    def test_create_post(self):
        ...
        data = {"title": "new", "author": 1,
                "excerpt": "New something New something New something New something New something", "content": "new"}
        url = reverse('blog_api:listcreate')
    ...
    def test_post_update(self):
        ...
        client.login(username=self.testuser1.username,  # testuser2 to gives error
                     password='123456789')
        ...
        response = client.put(
            url, {
                "title": "New",
                "author": 1,
                "excerpt": "New something New something New something New something New something",
                "content": "New",
                "status": "published"
            }, format='json')
        print(response.data)
